...
genai.configure(api_key='AIzaSyCGXw3MA8XtCDSHEBc2G7SpHUUVMy0cj8U')
...
def main(page: ft.Page):
    ...
    def send_message_click(e):
        ...
        if new_message.value != "":
            ...
            page.pubsub.send_all(
                Message("FletAI", "Thinking...", message_type="chat_message"))
            ...
            if question == ":verify":
                ...
                text = response.text
                page.pubsub.send_all(
                    Message("FletAI", text, message_type="chat_message"))
                ...
                if text.find(barcode_text) != -1:
                    page.pubsub.send_all(
                        Message("FletAI", barcode_text + " is correct ✓", message_type="chat_message"))
                else:
                    page.pubsub.send_all(
                        Message("FletAI", barcode_text + " may not be correct", message_type="chat_message"))
            else:
                if image_path == None:
                ...
                page.pubsub.send_all(
                    Message("FletAI", response.text, message_type="chat_message"))
